...
```scala
libraryDependencies += "com.stackmob" % "stackmob-java-client-sdk" % "0.3.1"
```

## Commandline

[Download this JAR](http://search.maven.org/remotecontent?filepath=com/stackmob/stackmob-java-client-sdk/0.3.1/stackmob-java-client-sdk-0.3.1.jar) and put it on your CLASSPATH

# Making REST API Calls

The main interface to your app on StackMob's servers is through the ``` com.stackmob.sdk.api.StackMob ``` object. Check out the [javadoc](http://stackmob.github.com/stackmob-java-client-sdk/javadoc/0.3.1/apidocs/) for details.
