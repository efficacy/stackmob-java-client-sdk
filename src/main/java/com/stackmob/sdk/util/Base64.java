 ...
 * <p> I am placing this code in the Public Domain. Do
...
public class Base64 {
    ...
    /**
     * The 64 valid Base64 values. made private and a method that returns a clone
     * can be added.
     */
    ...
    /**
     * The 64 valid web safe Base64 values. made private and a method that returns
     * a clone can be added.
     */
    ...
    /**
     * Encodes a byte array into Base64 notation. Equivalent to calling {@code encodeBytes(source.getBytes("UTF-8")}
     *
    ...
    public static String encode(String source) {
        ...
        return encode(bytes, 0, bytes.length, ALPHABET, true);
    }
